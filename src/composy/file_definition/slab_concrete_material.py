...
class SlabConcreteMaterial:
    _density_user_defined = {True: 'USER_DENSITY', False: 'CODE_DENSITY'}

    _e_ratio_user_defined = {True: 'USER_E_RATIO', False: 'CODE_E_RATIO'}

    _shrink_user_defined = {True: 'USER_E_RATIO', False: 'CODE_E_RATIO'}
