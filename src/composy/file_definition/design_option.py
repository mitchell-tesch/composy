...
class DesignOption:
    _beam_weight = {True: 'BEAM_WEIGHT_YES', False: 'BEAM_WEIGHT_NO'}
    _slab_weight = {True: 'SLAB_WEIGHT_YES', False: 'SLAB_WEIGHT_NO'}
    _shear_deform = {True: 'SHEAR_DEFORM_YES', False: 'SHEAR_DEFORM_NO'}
    _thin_section = {True: 'THIN_SECTION_YES', False: 'THIN_SECTION_NO'}
