...
class SlabDimension:
    _is_tapered = {True: 'TAPERED_YES', False: 'TAPERED_NO'}
    _override_eff_width = {True: 'EFFECTIVE_WIDTH_YES', False: 'EFFECTIVE_WIDTH_NO'}
    ...
    def __repr__(self) -> str:
        if self.override:
            return (
                f'SLAB_DIMENSION({self.num_slab},{self.slab_index},{self.depth},{self.width_left},{self.width_right},\
