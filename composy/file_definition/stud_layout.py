...
class StudLayout():
    _check_spacing = {True: 'CHECK_SPACE_YES',
                      False: 'CHECK_SPACE_NO'}
    ...
    def __str__(self) -> str:
        ...
        return f"STUD_LAYOUT,{self.member_name},{self.layout_type},{self.num_zones},{self.zone_index},{self.zone_start_pos},\
