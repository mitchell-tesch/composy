...
class EcDesignOption():
    _include_shrink_defl = {True: 'SHRINKAGE_DEFORM_EC4_YES',
                            False: 'SHRINKAGE_DEFORM_EC4_NO'}
    
    _ratio_ignore_shrink_defl = {True: 'IGNORE_SHRINKAGE_DEFORM_YES',
                                 False: 'IGNORE_SHRINKAGE_DEFORM_NO'}
    
    _approx_modular_ratio = {True: 'APPROXIMATE_E_RATIO_YES',
                             False: 'APPROXIMATE_E_RATIO_NO'}
